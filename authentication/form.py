...
class LoginForm(forms.Form):
    email = forms.CharField(label='Email')  # bebas format
...
class RegisterDokterForm(BaseRegisterForm):
    ...
    spesialis_lainnya = forms.CharField(label='Spesifikasi Spesialis Lainnya', required=False)
    no_izin_praktek = forms.CharField(label='No Izin Praktek')
