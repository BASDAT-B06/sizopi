...
urlpatterns = [
    ...
    path('admin/', views.adoption_list_admin, name='admin_list'),
    path('admin/adopters/', views.adopter_list, name='adopter_list'),
    path('admin/adopters/<int:adopter_id>/history/', views.adopter_history, name='adopter_history'),
